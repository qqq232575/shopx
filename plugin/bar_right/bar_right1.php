...
<link rel="stylesheet" href="<?php echo BASE_SITE_URL.'/plugin/bar_right/'?>styles.css">
...
<div id="ncToolbar" class="nc-appbar">
  <div class="nc-appbar-tabs" id="appBarTabs">
    ...
    <div class="user" nctype="a-barLoginBox">
      <div class="avatar"><i class="iconfont">&#xe654;</i></div>
    </div>
    ...
    <ul class="tools">
      <li><a href="javascript:void(0);" id="chat_show_user" class="chat"><i class="iconfont">&#xE64D;</i><i id="new_msg" class="new_msg" style="display:none;"></i></a></li>
      <?php if (!$output['hidden_rtoolbar_cart']) { ?>
      <li ><a href="javascript:void(0);" id="rtoolbar_cart" class="cart"><i class="iconfont">&#xE61A;</i><i id="rtoobar_cart_count" class=" new_msg" style="display:none;"></i>购物车</a></li>
      <?php } ?>
